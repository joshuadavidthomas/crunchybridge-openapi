...
Run `npm test` to build the bundle and validate these fixtures offline. After a build, run `npm run check:fixtures` to repeat only the fixture tests. CI never contacts Crunchy Bridge or needs an API key.
